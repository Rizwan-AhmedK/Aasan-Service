...
const submit = () => {
 ...
 <Button style={{marginTop: 50, backgroundColor: '#10047c', paddingLeft: 5, paddingRight: 5, marginBottom: 100}} mode="contained" onPress={() => navigation.navigate('UserSettings', {Id: val.data._id, userData: [data]})}>
             Edit Details
            </Button> 
        </View>    
