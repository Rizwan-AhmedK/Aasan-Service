...
const navigation = useNavigation();
    ...
    return (
        ...
        <Text style={{color: "white", fontSize: 30, paddingTop: 15, marginBottom: 10}}>Services</Text>
        </View>

        <View style={{backgroundColor: 'white', alignItems: 'center', flex: 2.5, borderTopLeftRadius: 30, borderTopRightRadius: 30}}>
        <View style={{alignItems: 'center', flexDirection: 'row'}} >
                <View style={{alignItems: 'center', margin: 12, marginRight: 45, alignContent: 'center', padding: 25, borderRadius: 10, marginTop: 40}}>
                ...
                <View style={{alignItems: 'center', margin: 8, marginRight: 25, alignContent: 'center', padding: 25, borderRadius: 10, marginTop: 40}}>
            ...
            <View style={{alignItems: 'center', flexDirection: 'row', paddingBottom: 5}}>
                <View style={{alignItems: 'center', margin: 8, marginRight: 35, alignContent: 'center', padding: 25, borderRadius: 10, marginBottom: 45}}>
                ...
                <View style={{alignItems: 'center', margin: 8, alignContent: 'center', marginRight: 20, padding: 25, borderRadius: 10, marginBottom: 45}}>
