...
const navigation = useNavigation();
    ...
    return (
        ...
        <View style={{backgroundColor: 'white', alignItems: 'center', flex: 2.5, borderTopLeftRadius: 30, borderTopRightRadius: 30}}>
            ...
            <Button style={{backgroundColor: '#10047c', marginTop: 30, paddingLeft: 8, paddingRight: 8}} mode="contained" onPress={() => navigation.navigate("AddMoreWorkScreen")}>
              Add More Work
            </Button>

            <Button style={{backgroundColor: 'green', marginTop: 10}} mode="contained" onPress={() => navigation.navigate("TaskCompleted")}>
              Task Completed
            </Button>
...
export default ViewDetailsUstaad;
