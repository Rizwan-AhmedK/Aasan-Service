...
import { View, Text, Image, StyleSheet, Button, Pressable, Picker  } from 'react-native';
    ...
    return(
        <View style={styles.SplashScreen_RootView}>  
                <View style={styles.SplashScreen_ChildView}>  
                    ...
                    <Pressable style={styles.buttonUstaad} onPress={() => navigation.navigate('LoginUstaad')} >
