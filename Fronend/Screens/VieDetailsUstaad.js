...
export default function ViewDetailsUstaad() {
const navigation = useNavigation();
    ...
    return (
        ...
        <View style={{backgroundColor: 'white', alignItems: 'center', flex: 2.5, borderTopLeftRadius: 30, borderTopRightRadius: 30}}>
            ...
            <Text style={{color: '#10047c', fontSize: 35, marginTop: 50, fontWeight: 'bold'}}>Date and Time</Text> 
            <Text style={{fontSize: 25, marginTop: 15, fontWeight: 'bold'}}>July 2, 2022, 11:00 am</Text>

            <Button style={{backgroundColor: '#10047c', marginTop: 30, paddingLeft: 8, paddingRight: 8}} mode="contained" onPress={() => navigation.navigate("UstaadMainScreen")}>
              Add More Work
            </Button>

            <Button style={{backgroundColor: 'green', marginTop: 10}} mode="contained" onPress={() => navigation.navigate("UstaadMainScreen")}>
              Task Completed
            </Button>

            <Button style={{backgroundColor: 'red', marginTop: 10, paddingLeft: 8, paddingRight: 8, marginBottom: 20}} mode="contained" onPress={() => navigation.navigate("UstaadMainScreen")}>
              Complain Now
            </Button>
