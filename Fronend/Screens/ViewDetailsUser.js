...
const navigation = useNavigation();
    ...
    return (
        ...
        <View style={{backgroundColor: 'white', alignItems: 'center', flex: 2.5, borderTopLeftRadius: 30, borderTopRightRadius: 30}}>
            ...
            <Button style={{backgroundColor: 'green', marginTop: 60}} mode="contained" onPress={() => navigation.navigate("UstaadMainScreen")}>
              Task Completed
            </Button>

            <Button style={{backgroundColor: 'red', marginTop: 20, paddingLeft: 8, paddingRight: 8}} mode="contained" onPress={() => navigation.navigate("UstaadMainScreen")}>
              Complain Now
            </Button>
        </View>           
  </View>
