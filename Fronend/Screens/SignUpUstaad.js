...
const navigation = useNavigation();
    ...
    return (
        ...
        <View style={{backgroundColor: 'white', alignItems: 'center', flex: 2.5, borderTopLeftRadius: 30, borderTopRightRadius: 30}}>
            ...
            <Button icon="arrow-right-bold" style={{backgroundColor: '#10047c', marginTop: 35}} mode="contained" onPress={() => navigation.navigate('SignUpUstaadStep2')}>
              Next
            </Button>

            <Text style={{paddingTop: 10}}>I already have an Account? <Text style={{color: '#10047c', fontWeight: 'bold'}}>SignIn</Text></Text>
